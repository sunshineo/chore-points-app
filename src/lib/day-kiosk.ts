...
export const DEFAULT_DAY_TASKS: DayTask[] = [
  ...
  { id: "seed-task-floss", title: "用牙线", emoji: "🦷", defaultPoints: 3 },
  { id: "seed-task-evening-brush", title: "刷牙", emoji: "🪥", defaultPoints: 3 },
  { id: "seed-task-pyjamas", title: "自己换睡衣", emoji: "🩳", defaultPoints: 2 },
