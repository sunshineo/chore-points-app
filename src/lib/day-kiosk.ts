...
export const DEFAULT_DAY_TASKS: DayTask[] = [
  ...
  { id: "seed-task-mom-hi", title: "跟妈妈说再见", emoji: "🙋", defaultPoints: 3 },
  ...
  { id: "seed-task-dinner", title: "晚饭吃干净", emoji: "🍽️", defaultPoints: 5 },
  { id: "seed-task-dinner-fruit", title: "晚饭后吃水果", emoji: "🍎", defaultPoints: 2 },
  { id: "seed-task-snack", title: "在学校吃光我们带的零食", emoji: "🍎", defaultPoints: 5 },
