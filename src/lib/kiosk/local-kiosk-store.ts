...
const DEFAULT_TASKS: KioskTask[] = [
  ...
  { id: "seed-task-seatbelt", title: "自己上车自己系安全带", emoji: "🚗", defaultPoints: 1, kind: "chore" },
  ...
  { id: "seed-task-grandma", title: "跟姥姥问好", emoji: "🙋", defaultPoints: 3, kind: "chore" },
  { id: "seed-task-mom", title: "跟妈妈问好", emoji: "🙋", defaultPoints: 3, kind: "chore" },
