...
enum Catalog {
    static let tasks: [CatalogItem] = [
        .init(id: "seed-task-brush", title: "早上刷牙", emoji: "🪥", points: 2, image: nil, isReward: false, englishTitle: "Brush my teeth in the morning", enabledByDefault: true),
        ...
        .init(id: "seed-task-shoes", title: "穿好鞋子", emoji: "👟", points: 1, image: nil, isReward: false, englishTitle: "Put on my shoes", enabledByDefault: false),
        ...
        .init(id: "seed-task-bedtime", title: "按约定时间上床", emoji: "🛌", points: 2, image: nil, isReward: false, englishTitle: "Go to bed at the agreed time", enabledByDefault: false),
        ...
        .init(id: "seed-task-laundry-basket", title: "把脏衣服放进洗衣篮", emoji: "🧺", points: 1, image: nil, isReward: false, englishTitle: "Put dirty clothes in the laundry basket", enabledByDefault: true),
        .init(id: "seed-task-put-things-away", title: "把用过的物品放回原处", emoji: "📦", points: 1, image: nil, isReward: false, englishTitle: "Put things back where they belong", enabledByDefault: true),
        .init(id: "seed-task-make-bed", title: "整理床铺", emoji: "🛏️", points: 2, image: nil, isReward: false, englishTitle: "Make my bed", enabledByDefault: false),
